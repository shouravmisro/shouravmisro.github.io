    ...
    <div className="grid gap-6 lg:grid-cols-[420px_1fr]">
      ...
      <div className="rounded-2xl border border-[rgb(var(--border))] p-6">
        ...
        <p className="mt-4 text-xs text-[rgb(var(--muted))]">
          Step now: <span className="font-semibold">{step.label}</span> (wizard UI will be fully implemented in Step 3+).
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-[rgb(var(--border))] p-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex gap-2">
            <button className="rounded-xl border border-[rgb(var(--border))] px-3 py-2 text-sm hover:bg-[rgb(var(--fg)/0.04)] transition">
              Site
            </button>
            <button className="rounded-xl border border-[rgb(var(--border))] px-3 py-2 text-sm hover:bg-[rgb(var(--fg)/0.04)] transition">
              CV
        ...
        <div className="mt-6 rounded-2xl border border-[rgb(var(--border))] p-6">
          <p className="text-sm text-[rgb(var(--muted))]">
            Preview will become split-screen interactive (site + CV tabs, mobile toggle) once we connect the schema and state.
          </p>
        </div>
      </div>
    </div>
